...
public class MemoryDatabase
{
    ...
    private void SeedActors()
    {
        ...
        {
            new Actor(1, "The Godfather", 1972, "A mafia patriarch hands the family empire to his reluctant son."), 
            new Actor(2, "The Godfather Part II", 1974, "Michael consolidates power as flashbacks trace Vito Corleone’s rise."),
            new Actor(3, "The Dark Knight", 2008, "Batman faces the Joker, who pushes Gotham into chaos."),
            new Actor(4, "The Shawshank Redemption", 1994, "An innocent banker forms a life-saving friendship in prison."),
            new Actor(5, "Pulp Fiction", 1994, "Interlocking LA crime stories unfold with dark humor."),
            new Actor(6, "Schindler's List", 1993, "A businessman saves Jewish workers during the Holocaust."),
            new Actor(7, "The Lord of the Rings: The Return of the King", 2003, "The final push to destroy the One Ring decides Middle-earth’s fate."),
            new Actor(8, "Fight Club", 1999, "An insomnia-plagued worker joins a charismatic anarchist’s secret club."),
            new Actor(9, "Forrest Gump", 1994, "A kind man unwittingly drifts through historic American moments."),
            new Actor(10, "Inception", 2010, "A thief enters dreams to plant an idea in a target’s mind."),
            new Actor(11, "The Matrix", 1999, "A hacker learns reality is a simulated prison for humanity."),
            new Actor(12, "Se7en", 1995, "Two detectives hunt a killer using the seven deadly sins."),
            new Actor(13, "Goodfellas", 1990, "Henry Hill’s rise and fall inside the New York mob."),
            new Actor(14, "The Silence of the Lambs", 1991, "An FBI trainee consults Hannibal Lecter to catch a serial killer."),
            new Actor(15, "Star Wars: Episode IV – A New Hope", 1977, "A farm boy joins rebels to destroy the Empire’s Death Star."),
            new Actor(16, "The Empire Strikes Back", 1980, "The Rebels scatter as Luke confronts Darth Vader."),
            new Actor(17, "Interstellar", 2014, "Astronauts travel through a wormhole to save a dying Earth."),
            new Actor(18, "Parasite", 2019, "A poor family infiltrates a wealthy household with unforeseen fallout."),
            new Actor(19, "Spirited Away", 2001, "A girl navigates a spirit bathhouse to free her parents."),
            new Actor(20, "City of God", 2002, "Two boys take diverging paths amid Rio’s gang wars."),
            new Actor(21, "Saving Private Ryan", 1998, "A squad risks everything to bring a paratrooper home."),
            new Actor(22, "The Green Mile", 1999, "Death-row guards encounter a prisoner with miraculous gifts."),
            new Actor(23, "Gladiator", 2000, "A betrayed general becomes Rome’s fiercest arena fighter."),
            new Actor(24, "The Lion King", 1994, "An exiled lion cub returns to claim his destiny."),
            new Actor(25, "Back to the Future", 1985, "A teen time-travels and risks erasing his own existence."),
            new Actor(26, "The Departed", 2006, "An infiltrator and a mole play cat- and - mouse in Boston."),
            new Actor(27, "Whiplash", 2014, "A jazz drummer endures a brutal mentor in pursuit of greatness."),
            new Actor(28, "The Prestige", 2006, "Rival magicians wage a dangerous war of one - upmanship."),
            new Actor(29, "The Usual Suspects", 1995, "A survivors’ tale hints at the legend of Keyser Söze."),
            new Actor(30, "Terminator 2: Judgment Day", 1991, "A reprogrammed cyborg protects the future leader of humanity."),
            new Actor(31, "Alien", 1979, "A crew is stalked by a lethal lifeform aboard a spaceship."),
            new Actor(32, "Aliens", 1986, "Ripley returns to face a hive of xenomorphs on LV - 426."),
            new Actor(33, "Blade Runner", 1982, "A detective hunts rogue androids in a neon - soaked future."),
            new Actor(34, "Apocalypse Now", 1979, "A captain journeys upriver to terminate a renegade officer."),
            new Actor(35, "One Flew Over the Cuckoo's Nest", 1975, "A rebel patient challenges a tyrannical nurse in a psych ward."),
            new Actor(36, "Taxi Driver", 1976, "A disturbed NYC cabbie spirals toward violence."),
            new Actor(37, "Oldboy", 2003, "A man seeks answers after 15 years of inexplicable captivity."),
            new Actor(38, "Amélie", 2001, "A shy Parisian decides to secretly improve others’ lives."),
            new Actor(39, "The Pianist", 2002, "A Jewish pianist struggles to survive Warsaw’s ghetto."),
            new Actor(40, "American Beauty", 1999, "A suburban man’s midlife crisis upends his family."),
            new Actor(41, "No Country for Old Men", 2007, "A stolen briefcase triggers relentless pursuit across Texas."),
            new Actor(42, "There Will Be Blood", 2007, "An oilman’s ambition consumes everything around him."),
            new Actor(43, "Mad Max: Fury Road", 2015, "A desert chase pits a warlord against a defiant road warrior."),
            new Actor(44, "La La Land", 2016, "A musician and an actress chase dreams in modern LA."),
            new Actor(45, "Joker", 2019, "A marginalized comedian’s breakdown sparks violent unrest."),
            new Actor(46, "Avengers: Infinity War", 2018, "Earth’s heroes battle Thanos for the fate of half the universe."),
            new Actor(47, "Avengers: Endgame", 2019, "Survivors attempt a time-heist to undo cosmic devastation."),
            new Actor(48, "Toy Story", 1995, "Rivalry between a cowboy doll and a space ranger turns to friendship."),
            new Actor(49, "Inside Out", 2015, "A girl’s emotions guide her through a difficult move."),
            new Actor(50, "The Social Network", 2010, "Facebook’s founding sparks friendship and legal battles.")
});
    }
