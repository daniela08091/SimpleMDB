...
public class MemoryDatabase
{
    ...
    private void SeedActors()
    {
        Actors.AddRange(new[]
        {
            new Actor(1,"Al Pacino"),
            new Actor(2,"Robert De Niro"),
            new Actor(3,"Christian Bale"),
            new Actor(4,"Heath Ledger"),
            new Actor(5,"Leonardo DiCaprio"),
            new Actor(6,"Brad Pitt"),
            new Actor(7,"Tom Hanks"),
            new Actor(8,"Morgan Freeman"),
            new Actor(9,"Keanu Reeves"),
            new Actor(10,"Matthew McConaughey"),
            new Actor(11,"Joaquin Phoenix"),
            new Actor(12,"Russell Crowe"),
            new Actor(13,"Ryan Gosling"),
            new Actor(14,"Emma Stone"),
            new Actor(15,"Scarlett Johansson")
        });
    }
    ...
    private void SeedUsers()
    {
        Users.AddRange(new[]
        {
            new User(1,"Maria Garcia","mgarcia9867@interbayamon.edu"),
            new User(2,"Sofia Gonzalez","sgonzalez2343@interbayamon.edu"),
            new User(3,"Nushi Smith","nsmith6545@interbayamon.edu"),
            new User(4,"Wei Wang","wwang5456@interbayamon.edu"),
            new User(5,"Harry Mohamed","hmohamed8032@interbayamon.edu"),
            new User(6,"Yan Kim","ykim4970@interbayamon.edu"),
            new User(7,"Sebastian Lopez","slopez4764@interbayamon.edu"),
            new User(8,"Juan Rodriguez","jrodriguez9873@interbayamon.edu"),
            new User(9,"Valeria Gonzalez","vgonzalez2254@interbayamon.edu"),
            new User(10,"Jorge Rivera","jrivera9873@interbayamon.edu")
        });
    }
